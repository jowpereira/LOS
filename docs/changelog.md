...
## v3.3.7 - Python Exporter
### ✨ Features
- **[ADD]** `LOSModel.export_python(file_path)`: Exports compiled LOS models into standalone, readable Python scripts that can be run independently using PuLP.

### 📚 Documentation
- **[CHG]** Added `export_python()` usage examples inside `README.md` and `MANUAL.md`.
